...
=======
5. If you found a significant difference in overclaiming in the analysis above (#4), re-perform the analysis from #3 to check to see if the relationship between self-perceived knowledge and overclaiming changes, when taking into account the order of the tasks. To do this, use the split file function, splitting the file based on order condition, before re-performing the analyses from #3. After you have performed the analyses, make sure to turn split file off.
...
>>>>>>> c736714f4ed6bec24beb512a389f76cab3b6c6f0
